...
import { BellIcon } from "@/components/salesman/icons";
...
export function SalesmanTopBar({ title, subtitle, back = false, hideAlerts = false, right }: SalesmanTopBarProps) {
