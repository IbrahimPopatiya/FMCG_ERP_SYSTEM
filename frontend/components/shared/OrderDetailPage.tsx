...
export interface OrderDetailPageProps {
  // Where the back button goes. Defaults to browser history (customer app).
  // The salesman app passes its products page instead, so placing one
  // customer's order doesn't strand the salesman back in the cart they just
  // cleared - they land somewhere they can pick the next customer.
  backHref?: string;
}

export function OrderDetailPage({ backHref }: OrderDetailPageProps) {
