...
WIPE_ORDER = [
    ...
    PriceList,
    Post,  # before Product (product_id) and User (created_by)
    Product,
    Category,
    Brand,
    Route,
...
def seed_products(db, categories: dict, brands: dict, created_by) -> dict:
    print("Step 8/14: Creating products...")
    # (key, name, category, brand, unit, mrp, price, gst, min_stock) - sku is
    # auto-generated by product_service.create_product
    specs = [
        ("coke", "Coca-Cola 500ml", "soft_drinks", "Coca-Cola", "bottle", "40.00", "35.00", "18.00", 50),
        ("coke_1l", "Coca-Cola 1L", "soft_drinks", "Coca-Cola", "bottle", "60.00", "52.00", "18.00", 40),
        ("sprite", "Sprite 500ml", "soft_drinks", "Coca-Cola", "bottle", "40.00", "35.00", "18.00", 50),
        ("thums_up", "Thums Up 500ml", "soft_drinks", "Coca-Cola", "bottle", "40.00", "35.00", "18.00", 50),
        ("pepsi", "Pepsi 500ml", "soft_drinks", "PepsiCo", "bottle", "40.00", "34.00", "18.00", 50),
        ("mirinda", "Mirinda Orange 500ml", "soft_drinks", "PepsiCo", "bottle", "40.00", "34.00", "18.00", 40),
        ("7up", "7UP 500ml", "soft_drinks", "PepsiCo", "bottle", "40.00", "34.00", "18.00", 40),
        ("tropicana", "Tropicana Orange 1L", "juices", "Tropicana", "carton", "110.00", "95.00", "12.00", 30),
        ("real_juice", "Real Mixed Fruit 1L", "juices", "Dabur", "carton", "100.00", "88.00", "12.00", 30),
        ("bisleri", "Bisleri Water 1L", "soft_drinks", "Bisleri", "bottle", "20.00", "16.00", "0.00", 100),
        ("lays", "Lay's Classic 52g", "chips", "PepsiCo", "packet", "20.00", "18.00", "12.00", 100),
        ("lays_magic", "Lay's Magic Masala 52g", "chips", "PepsiCo", "packet", "20.00", "18.00", "12.00", 100),
        ("kurkure", "Kurkure Masala Munch 55g", "chips", "PepsiCo", "packet", "20.00", "18.00", "12.00", 100),
        ("uncle_chips", "Uncle Chipps Spicy 55g", "chips", "PepsiCo", "packet", "20.00", "18.00", "12.00", 80),
        ("haldiram_bhujia", "Haldiram Bhujia 200g", "snacks", "Haldiram", "packet", "55.00", "48.00", "12.00", 60),
        ("haldiram_mixture", "Haldiram Mixture 200g", "snacks", "Haldiram", "packet", "55.00", "48.00", "12.00", 60),
        ("parle_g", "Parle-G Biscuit 200g", "biscuits", "Parle", "packet", "25.00", "22.00", "5.00", 80),
        ("monaco", "Parle Monaco 200g", "biscuits", "Parle", "packet", "30.00", "26.00", "5.00", 70),
        ("good_day", "Britannia Good Day 100g", "biscuits", "Britannia", "packet", "30.00", "27.00", "5.00", 80),
        ("marie_gold", "Britannia Marie Gold 250g", "biscuits", "Britannia", "packet", "40.00", "35.00", "5.00", 70),
        ("bourbon", "Britannia Bourbon 120g", "biscuits", "Britannia", "packet", "35.00", "30.00", "5.00", 60),
        ("sunfeast", "Sunfeast Dark Fantasy 75g", "biscuits", "Sunfeast", "packet", "40.00", "35.00", "5.00", 60),
        ("amul_milk", "Amul Milk 500ml", "dairy", "Amul", "pouch", "30.00", "28.00", "0.00", 40),
        ("amul_milk_1l", "Amul Milk 1L", "dairy", "Amul", "pouch", "56.00", "52.00", "0.00", 40),
        ("amul_butter", "Amul Butter 500g", "dairy", "Amul", "pack", "250.00", "230.00", "12.00", 20),
        ("amul_cheese", "Amul Cheese Slices 200g", "dairy", "Amul", "pack", "120.00", "110.00", "12.00", 20),
        ("amul_ghee", "Amul Ghee 1L", "dairy", "Amul", "tin", "620.00", "580.00", "12.00", 15),
        ("mother_curd", "Mother Dairy Curd 400g", "dairy", "Mother Dairy", "cup", "35.00", "30.00", "0.00", 30),
        ("maggi", "Nestle Maggi Noodles 70g", "instant_food", "Nestle", "packet", "14.00", "12.00", "12.00", 150),
        ("maggi_4", "Nestle Maggi 4-Pack", "instant_food", "Nestle", "pack", "55.00", "48.00", "12.00", 80),
        ("yippee", "Sunfeast Yippee 70g", "instant_food", "Sunfeast", "packet", "14.00", "12.00", "12.00", 100),
        ("milkmaid", "Nestle Milkmaid 400g", "staples", "Nestle", "tin", "90.00", "82.00", "12.00", 30),
        ("atta", "Aashirvaad Atta 5kg", "staples", "ITC", "bag", "250.00", "230.00", "5.00", 30),
        ("atta_10", "Aashirvaad Atta 10kg", "staples", "ITC", "bag", "480.00", "450.00", "5.00", 20),
        ("rice", "India Gate Basmati 1kg", "staples", "ITC", "pack", "180.00", "165.00", "5.00", 40),
        ("sugar", "Madhur Sugar 1kg", "staples", "Patanjali", "pack", "48.00", "42.00", "0.00", 50),
        ("salt", "Tata Salt 1kg", "staples", "ITC", "pack", "28.00", "24.00", "0.00", 80),
        ("fortune_oil", "Fortune Sunflower Oil 1L", "oils", "ITC", "bottle", "160.00", "145.00", "5.00", 40),
        ("saffola", "Saffola Gold 1L", "oils", "Marico", "bottle", "210.00", "190.00", "5.00", 30),
        ("parachute", "Parachute Coconut Oil 500ml", "oils", "Marico", "bottle", "230.00", "210.00", "18.00", 40),
        ("surf_excel", "Surf Excel 1kg", "household", "HUL", "pack", "180.00", "165.00", "18.00", 25),
        ("surf_excel_5", "Surf Excel 5kg", "household", "HUL", "pack", "750.00", "700.00", "18.00", 15),
        ("vim", "Vim Dishwash Bar", "household", "HUL", "piece", "20.00", "18.00", "18.00", 200),
        ("vim_liq", "Vim Liquid 500ml", "household", "HUL", "bottle", "110.00", "98.00", "18.00", 40),
        ("lizol", "Lizol Floor Cleaner 500ml", "household", "HUL", "bottle", "110.00", "98.00", "18.00", 40),
        ("harpic", "Harpic Toilet Cleaner 500ml", "household", "HUL", "bottle", "95.00", "85.00", "18.00", 40),
        ("godrej_aer", "Godrej Aer Pocket", "household", "Godrej", "piece", "55.00", "48.00", "18.00", 50),
        ("dove", "Dove Soap 100g", "personal_care", "HUL", "piece", "55.00", "50.00", "18.00", 100),
        ("lux", "Lux Soap 100g", "personal_care", "HUL", "piece", "40.00", "35.00", "18.00", 100),
        ("lifebuoy", "Lifebuoy Soap 100g", "personal_care", "HUL", "piece", "30.00", "26.00", "18.00", 120),
        ("clinic_plus", "Clinic Plus Shampoo 180ml", "personal_care", "HUL", "bottle", "120.00", "105.00", "18.00", 50),
        ("sunsilk", "Sunsilk Shampoo 180ml", "personal_care", "HUL", "bottle", "130.00", "115.00", "18.00", 50),
        ("colgate", "Colgate Toothpaste 200g", "oral_care", "Colgate", "tube", "150.00", "140.00", "18.00", 60),
        ("colgate_100", "Colgate Toothpaste 100g", "oral_care", "Colgate", "tube", "75.00", "68.00", "18.00", 80),
        ("pepsodent", "Pepsodent Toothpaste 150g", "oral_care", "HUL", "tube", "95.00", "85.00", "18.00", 60),
        ("closeup", "Closeup Toothpaste 150g", "oral_care", "HUL", "tube", "95.00", "85.00", "18.00", 60),
        ("dabur_red", "Dabur Red Toothpaste 200g", "oral_care", "Dabur", "tube", "110.00", "98.00", "18.00", 50),
        ("dairy_milk", "Cadbury Dairy Milk 45g", "confectionery", "Mondelez", "bar", "40.00", "35.00", "18.00", 100),
        ("5star", "Cadbury 5 Star 40g", "confectionery", "Mondelez", "bar", "20.00", "18.00", "18.00", 100),
        ("perk", "Cadbury Perk 28g", "confectionery", "Mondelez", "bar", "10.00", "9.00", "18.00", 150),
        ("kissan_jam", "Kissan Mixed Fruit Jam 500g", "confectionery", "Kissan", "jar", "160.00", "145.00", "12.00", 30),
        ("patanjali_honey", "Patanjali Honey 500g", "confectionery", "Patanjali", "jar", "180.00", "160.00", "5.00", 30),
    ]
    products = {}
    for key, name, cat_key, brand_key, unit, mrp, price, gst, min_stock in specs:
...
def main() -> None:
    ...
    try:
        ...
        products = seed_products(db, categories, brands, users["admin"].id)
